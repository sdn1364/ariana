        ...
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-filemanager-table-toolbar="base">
                    @if($folderId)
                        <a href="#" wire:click="goBack()" class="btn btn-icon btn-light-primary me-3">
                    ...
                    @endif
                        <button type="button" class="btn btn-sm btn-success" wire:model="addFiles()">
                            اضافه کردن
                        </button>
                </div>
            ...
            <table id="kt_file_manager_list" data-kt-filemanager-table="folders" class="table align-middle table-row-dashed fs-6 gy-5">
                    ...
                    <tr>
                        ...
                        <td data-order="account">
                            <div class="d-flex align-items-center">
                                ...
                                <a href="#" type="button" class="text-gray-800 text-hover-primary" wire:click="changeFolder('{{ $folder->id }}')">{{ $folder->name }}</a>
                            </div>
                        </td>
                ...
                @foreach( $files as $file )
                    <tr>
                        <td>
                            <div class="form-check form-check-sm form-check-custom form-check-solid">
                                <input class="form-check-input" wire:model="addToFiles" wire:model="selectedFiles" type="checkbox" value=" {{$file->id}} "/>
                            </div>
                        </td>
                        <td data-order="account">
                            <div class="d-flex align-items-center">
